...
export const quizData = [
  ...
  },
  {
    ...
    image: "/images/soal-20.png",
    options: { a: "Banten", b: "Jawa Barat", c: "Jawa Timur", d: "Jawa Tengah" },
    answer: "b",
  },
  // Soal 21-50
  { no: 21, question: "Makanan khas Papua yang terbuat dari sagu adalah…", image: "/images/soal-21.png", options: { a: "Soto Banjar", b: "Pepes Ikan", c: "Papeda", d: "Sate Lilit" }, answer: "c" },
  ...
  { no: 23, question: "Manakah yang merupakan seni pertunjukan Papua Barat Daya?", image: "/images/soal-23.png", options: { a: "Tari Adat Suku Marind", b: "Tari Yospan", c: "Festival Budaya Lembah Baliem", d: "Tarian Perang Papua" }, answer: "d" },
  { no: 24, question: "Manakah yang merupakan alat musik daerah Papua Pegunungan?", image: "/images/soal-24.png", options: { a: "Japen", b: "Tifa", c: "Gambang Kayu", d: "Pikon (Kaido)" }, answer: "d" },
  { no: 25, question: "Manakah yang merupakan seni pertunjukan Maluku Utara?", image: "/images/soal-25.png", options: { a: "Ma’badong", b: "Bambu Gila", c: "Kabasaran Show", d: "Totobuang" }, answer: "b" },
  { no: 26, question: "Manakah tarian yang berasal dari Gorontalo?", image: "/images/soal-26.png", options: { a: "Tari Saronde", b: "Tari Pamonte", c: "Tari Sayyang Pattuddu’", d: "Tari Pakarena" }, answer: "a" },
  { no: 27, question: "Mana saja yang merupakan makanan Sulawesi Tengah?", image: "/images/soal-27.png", options: { a: "Mie Sagu dan Konro", b: "Coto Makassar, Pallubasa dan Konro", c: "Kaledo, Uta Kelo dan Lalampa", d: "Jepa dan Kue Kui-kui" }, answer: "c" },
  ...
  { no: 29, question: "Dimana ibu kota provinsi Jambi berada?", image: "/images/soal-29.png", options: { a: "Jambi", b: "Tebo", c: "Muaro Jambi", d: "Sungai Penuh" }, answer: "a" },
  ...
  { no: 31, question: "Manakah yang merupakan seni pertunjukan Bengkulu?", image: "/images/soal-31.png", options: { a: "Dulmuluk", b: "Tabot", c: "Cangget", d: "Mamapas Lewu" }, answer: "b" },
  ...
  { no: 33, question: "Manakah yang merupakan seni pertunjukan Kalimantan Barat?", image: "/images/soal-33.png", options: { a: "Hudoq Festival", b: "Sandung", c: "Wayang", d: "Mamapas Lewu" }, answer: "b" },
  ...
  { no: 35, question: "Manakah lagu daerah yang berasal dari Kalimantan Selatan?", image: "/images/soal-35.png", options: { a: "Gemufamire", b: "Ampar-Ampar Pisang", c: "Suwe Ora Jamu", d: "Manuk Dadali" }, answer: "b" },
  ...
  { no: 37, question: "Manakah yang merupakan ibu kota provinsi NTB?", image: "/images/soal-37.png", options: { a: "Bima", b: "Mataram", c: "Sumbawa", d: "Lombok" }, answer: "b" },
  ...
  { no: 39, question: "Manakah yang merupakan makanan khas Jawa Barat?", image: "/images/soal-39.png", options: { a: "Sate Lilit", b: "Kerak Telor", c: "Gudeg", d: "Batagor" }, answer: "d" },
  ...
  { no: 41, question: "Manakah yang merupakan seni pertunjukan Jawa Timur?", image: "/images/soal-41.png", options: { a: "Wayang Kulit", b: "Tari Kuda Lumping", c: "Lenong", d: "Ludruk" }, answer: "a" },
  { no: 42, question: "Dimana ibu kota provinsi Kalimantan Selatan berada?", image: "/images/soal-42.png", options: { a: "Banjarbaru", b: "Martapura", c: "Banjarmasin", d: "Marabahan" }, answer: "c" },
  ...
  { no: 44, question: "Dimana ibu kota provinsi Kalimantan Utara berada?", image: "/images/soal-44.png", options: { a: "Tarakan", b: "Bulungan", c: "Tanjung Selor", d: "Malinau" }, answer: "c" },
  ...
  { no: 46, question: "Dimana ibu kota provinsi Papua Barat berada?", image: "/images/soal-46.png", options: { a: "Jayapura", b: "Manokwari", c: "Merauke", d: "Wanggar, Nabire" }, answer: "b" },
  { no: 47, question: "Manakah lagu daerah yang berasal dari Papua Selatan?", image: "/images/soal-47.png", options: { a: "Jayawijaya Hanorasuok", b: "E Mambo Simbo", c: "Kampuang Nan Jauh di Mato", d: "Yamko Rambe Yambo" }, answer: "b" },
  { no: 48, question: "Manakah yang merupakan seni pertunjukan Maluku?", image: "/images/soal-48.png", options: { a: "Ma’badong", b: "Mpae", c: "Kabasaran Show", d: "Totobuang" }, answer: "d" },
  { no: 49, question: "Dimana ibu kota provinsi Sulawesi Utara berada?", image: "/images/soal-49.png", options: { a: "Manado", b: "Bitung", c: "Kotamobagu", d: "Tomohon" }, answer: "a" },
